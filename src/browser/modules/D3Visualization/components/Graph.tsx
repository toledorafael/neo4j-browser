  ...
  initGraphView() {
    if (!this.graphView) {
      ...
      this.graphEH = new GraphEventHandler(
        ...
        this.props.getWhoCanCallThis,
        this.props.getWhatAreTheArgs,
        this.props.getInWhichClassIsItDefined,
        this.props.getWhereIsMethodCalled,
        this.props.getAreAllCallsComingFromSameClass,
        this.props.getWhatCanUpdatethis,
        this.props.getWhereIsItDeclared,
        this.props.getWhereIsItAccessed,
        this.props.getWhereAreInstancesCreated,
        this.props.getWhatDataCanWeAccess,
        this.props.getIncomingVarInfFunc,
        this.props.getOutgoingCall,
        this.props.getOutgoingWrite,
        this.props.getOutgoingContainFunction,
        this.props.getIncomingParWrite,
        this.props.getIncomingVarWrite,
        this.props.getIncomingContainVariable,
        this.props.getOutgoingVarInfFunc,
        this.props.getOutgoingVarWrite,
        this.props.getOutgoingParWrite,
        this.props.getOutgoingInstanceOf,
        this.props.getOutgoingContain,
